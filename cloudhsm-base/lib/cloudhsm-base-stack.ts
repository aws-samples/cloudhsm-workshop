...
// Constants
const EC2_INSTANCE_TYPE = 't3.medium';
...
export class CloudhsmBaseStack extends cdk.Stack {
    ...
    public cuCredentials: secretsmanager.Secret;
    public coCredentials: secretsmanager.Secret;
    ...
    constructor(scope: Construct, id: string, props: CloudhsmBaseStackProps) {
        ...
        const clusterCreationResult = this.createCloudHsmCluster(this.adminInstance, privateSubnets);
        ...
        const { ip: primaryNodeIp, node: primaryNode } = this.createCloudHsmNode('PrimaryHsmNode', {
            ClusterId: this.clusterId,
            AvailabilityZones: this._availabilityZones.join(','),
        });

        // 8. Initialize cluster
        const { rsaKey, selfSignedCert, initializedCluster } = this.initializeCluster(this.clusterId);
        ...
        // 9. Activate cluster
        const {
            coCredentials: coCredentials,
            cuCredentials: cuCredentials,
            activatedClusterTarget,
        } = this.activateCluster(this.adminInstance, this.clusterId, primaryNodeIp);
        this.cuCredentials = cuCredentials;
        this.coCredentials = coCredentials;

        activatedClusterTarget.node.addDependency(this.initializeClusterProvider.onEventHandler);
        ...
        if (!this.expressMode) {
            const { ip: secondNodeIp, node: secondNode } = this.createCloudHsmNode('SecondHsmNode', {
                ClusterId: this.clusterId,
    ...
    private createNetworkResources(): ec2.SecurityGroup {
        ...
        ec2InstanceSG.addIngressRule(ec2.Peer.anyIpv4(), ec2.Port.tcp(22), 'Allow SSH for SSM Session Manager');
    ...
    private createCloudHsmNodeProvider(): custom.Provider {
        ...
        const isCompleteFunction = new lambda.Function(this, 'cloudHsm2ProviderIsComplete', {
            runtime: LAMBDA_PYTHON_RUNTIME,
            code: lambda.Code.fromAsset('./custom_resources/cloudhsm_hsm/'),
    ...
    private createCloudHsmClusterProvider(): custom.Provider {
        ...
        const cloudhsmClusterProvider = new custom.Provider(this, 'cloudHSMClusterCR', {
    ...
    private createClusterReadyProvider(): custom.Provider {
        const clusterReadyFunction = new lambda.Function(this, 'ClusterReadyFunction', {
            runtime: LAMBDA_PYTHON_RUNTIME,
        ...
        const isCompleteFunction = new lambda.Function(this, 'ClusterReadyIsCompleteFunction', {
            runtime: LAMBDA_PYTHON_RUNTIME,
            code: lambda.Code.fromAsset('./custom_resources/cluster_ready_gate/'),
            handler: 'lambda_function.isComplete',
        });
    ...
    private createActivateClusterProvider(): custom.Provider {
        ...
        const isCompleteFunction = new lambda.Function(this, 'activateClusterCompleteFunction', {
            runtime: LAMBDA_PYTHON_RUNTIME,
            code: lambda.Code.fromAsset('./custom_resources/activate_cluster'),
            handler: 'lambda_function.isComplete',
            architecture: lambda.Architecture.X86_64,
    ...
    private createInitializeClusterProvider(): custom.Provider {
        ...
        const SECRET_ARN = `arn:aws:secretsmanager:${this.region}:${this.account}:secret:/cloudhsm/workshop/*`; //pragma: allowlist secret
        ...
        const isCompleteFunction = new lambda.Function(this, 'initializeClusterIsCompleteFunction', {
            runtime: LAMBDA_PYTHON_RUNTIME,
    ...
    private initializeCluster(clusterId: string): {
        ...
        const initializedCluster = new cdk.CustomResource(this, 'initializeClusterCR', {
    ...
    private activateCluster(
        ...
        coCredentials: secretsmanager.Secret;
        cuCredentials: secretsmanager.Secret;
        activatedClusterTarget: cdk.CustomResource;
    } {
        const coCredentials = new secretsmanager.Secret(this, 'coPassword', {
        ...
        const cuCredentials = new secretsmanager.Secret(this, 'cuPassword', {
        ...
        const activateScriptAsset = new Asset(this, 'activateScript', {
            path: path.join('./custom_resources/activate_cluster/activate_cluster.sh'),
        });
        ...
        const targetActivatedCluster = new cdk.CustomResource(this, 'activateCluster', {
            serviceToken: this.activateClusterProvider.serviceToken,
            properties: {
                InstanceId: instance.instanceId,
                COSecret: coCredentials.secretName,
                CUSecret: cuCredentials.secretName,
        ...
        targetActivatedCluster.node.addDependency(coCredentials);
        targetActivatedCluster.node.addDependency(cuCredentials);
    ...
    private createAdminInstanceRole(): iam.IRole {
        ...
        const secretsManagerPolicy = new iam.Policy(this, 'adminSecretsManagerPolicy', {
            statements: [
                new iam.PolicyStatement({
                    effect: iam.Effect.ALLOW,
                    actions: [
                    ...
                    resources: [`arn:aws:secretsmanager:${this.region}:${this.account}:secret:/cloudhsm/workshop/*`],
                }),
            ],
        });
    ...
    private createClientInstanceRole(): iam.IRole {
        ...
        const secretsManagerPolicy = new iam.Policy(this, 'clientSecretsManagerPolicy', {
            statements: [
                new iam.PolicyStatement({
                    effect: iam.Effect.ALLOW,
                    actions: [
    ...
    private getOnePrivateSubnetPerAZ(): ec2.ISubnet[] {
        ...
        allPrivateSubnets.forEach((subnet) => {
            ...
            if (!subnetPerAZ.has(az) || subnet.subnetId < subnetPerAZ.get(az)!.subnetId) {
    ...
    private createOutputs(): void {
        ...
        new cdk.CfnOutput(this, 'CUPasswordSecretName', {
            value: this.cuCredentials.secretName,
